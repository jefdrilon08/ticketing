...
RSpec.describe 'Show Equity Accounts' do
  include ApiHelpers
  ...
  let (:member_account) { FactoryBot.create(:member_account, member: member, account_type: 'EQUITY') }
  let (:inactive_member_account) { FactoryBot.create(:member_account, member: inactive_member) }

  describe "GET /api/members/equity_accounts/:id", type: :request do
    ...
    context 'valid calls' do
      it 'succeeds to return equity account data' do
