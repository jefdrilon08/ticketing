namespace :api do
  ...
  namespace :v1 do
    ...
    namespace :tickets do
      ...
      post "/concern_tickets/edit_all_fields", to: "concern_tickets#edit_all_fields"
      ...
      # post "/concern_tickets/edit_concern_category", to: "concern_tickets#edit_concern_category"
