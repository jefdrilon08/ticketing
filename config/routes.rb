...
Rails.application.routes.draw do
 ...
 # INVENTORY REQUEST
  ...
  get "/inventory_requests/:inventory_request_id/inventory_request_details/:id/edit", to: "inventory_request_details#edit", as: "edit_inventory_request_detail"
  ...
  delete "/inventory_requests/:inventory_request_id/details/:index", to: "inventory_request_details#destroy_json_detail", as: "destroy_inventory_request_json_detail"
  ...
  post "system_tickets/for_enhancement/:id",to: "system_tickets#for_enhancement"
  ...
  post "system_tickets/create_requirement", to: "system_tickets#create_requirement"
  ...
  post "system_tickets/edit_requirement_details", to: "system_tickets#edit_requirement_details" 
  post "system_tickets/checkbox",           to: "system_tickets#checkbox" 
  ...
  post "system_tickets/require_testing",       to: "system_tickets#require_testing"  
